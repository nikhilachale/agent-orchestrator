...
const (
	...
	sessionsHarnessCheckWithMuseKimchiPrimeAgentDeepSeekOMP   = `CHECK (harness IN ('', 'claude-code', 'codex', 'aider', 'opencode', 'grok', 'droid', 'amp', 'agy', 'crush', 'cursor', 'qwen', 'copilot', 'goose', 'auggie', 'continue', 'devin', 'cline', 'kimi', 'muse', 'kiro', 'kilocode', 'vibe', 'pi', 'kimchi', 'prime-agent', 'autohand', 'deepseek-harness', 'omp', 'fake'))`
	sessionsHarnessCheckWithMuseQMKimchiPrimeAgentDeepSeekOMP = `CHECK (harness IN ('', 'claude-code', 'codex', 'aider', 'opencode', 'grok', 'droid', 'amp', 'agy', 'crush', 'cursor', 'qwen', 'copilot', 'goose', 'auggie', 'continue', 'devin', 'cline', 'kimi', 'muse', 'kiro', 'kilocode', 'vibe', 'pi', 'kimchi', 'prime-agent', 'autohand', 'deepseek-harness', 'omp', 'qm', 'fake'))`
)
...
func reconcileHarnessConstraint(db *sql.DB) error {
	...
	if !needsMuse && !needsKimchi && !needsPrimeAgent && !needsDeepSeek && !needsOMP {
		return nil
	}
	...
	if needsOMP {
		repairs = append(repairs,
			replacement{sessionsHarnessCheckWithMuseKimchiPrimeAgentDeepSeek, sessionsHarnessCheckWithMuseKimchiPrimeAgentDeepSeekOMP},
			replacement{sessionsHarnessCheckWithMuseQMKimchiPrimeAgentDeepSeek, sessionsHarnessCheckWithMuseQMKimchiPrimeAgentDeepSeekOMP},
		)
	}
