...
const KNOWN_REVIEWER_HARNESS_IDS = new Set(["claude-code", "codex", "opencode", "amp", "aider"]);
...
const REVIEWER_AGENT_PRIORITY = ["claude-code", "codex", "cursor", "opencode", "amp", "aider"] as const;
