	...
	"inline-flex items-center transition-[filter,background,color,border-color] duration-fast disabled:opacity-60",
	{
		variants: {
			variant: {
				...
				newTask:
					"h-control-lg gap-1.5 rounded-md border border-error px-4 text-control font-semibold leading-none bg-error text-destructive-foreground hover:brightness-110",
