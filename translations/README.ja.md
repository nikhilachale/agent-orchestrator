...
<table>
  <tr>
    <td width="36%" valign="middle">
      <h3>注意すべきことが分かる Kanban</h3>
      <p>進行中、対応が必要、レビュー中、マージ可能など、実行状況とプルリクエストのライブ状態ごとに作業を確認できます。</p>
    </td>
    <td width="64%">
      <img src="../docs/assets/readme/hero.png" alt="進行中、対応が必要、レビュー中、マージ可能の各状態にワーカーセッションを分類する Agent Orchestrator の Kanban" width="100%" />
    </td>
  </tr>
  <tr>
    <td width="36%" valign="middle">
      <h3>隔離されたワーカー、自由に選べるエージェント</h3>
      <p>Git を使う各ワーカーに専用のブランチと worktree を割り当て、タスクに合ったコーディングエージェントを選び、構造化された Chat またはエージェント本来のターミナル UI を利用できます。</p>
    </td>
    <td width="64%">
      <img src="../docs/assets/readme/tui.png" alt="Agent Orchestrator 内で監督されているコーディングエージェント本来のターミナル UI" width="100%" />
    </td>
  </tr>
  <tr>
    <td width="36%" valign="middle">
